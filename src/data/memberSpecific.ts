  ...
  THEBOYZ: {
    members: {
      상연: {
        ...
        imgs: [],
        birth: "1996-11-04 서울특별시 송파구 가락동",
        nationality: "대한민국",
      ...
      케빈: {
        ...
        englishName: "Kevin",
        imgs: [],
        birth: "1998년 2월 23일 [빠른생일] (26세) 광주광역시",
        nationality: "캐나다",
  ...
  ZEROBASEONE: {
    members: {
      성한빈: {
        ...
        familys: [
          "아버지 성현모, 어머니 한혜정",
          "여동생 성한아름(2005년생), 반려견 보리(포메라니안), 관심(블랙탄 포메라니안)",
        ],
        academics: [
          "천안봉서초등학교 (졸업)",
          "천안계광중학교 (졸업)",
      ...
      석매튜: {
        name: "Matthew Woohyun Seok (매튜 우현 석) 석우현 (石友鉉, Seok Woohyun)",
        englishName: "Matthew",
        imgs: [],
      ...
      김규빈: {
        ...
        familys: [
          "부모님, 첫째 남동생 김규민(2007년생), 둘째 남동생 김규완(2008년생), 여동생 김규리(2010년 11월 30일생)",
